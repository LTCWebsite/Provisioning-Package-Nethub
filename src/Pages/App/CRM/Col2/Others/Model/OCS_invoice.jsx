                                ...
                                {loading ?
                                    ...
                                    : <MyTable
                                        ...
                                        tColumns={[
                                            ...
                                            { title: "Monthly", field: "dateTime" },
                                            { title: "AcctCode", field: "AcctCode", render: row => row?.invoice_data[0]?.AcctCode },
                                            { title: "Trans_Type", field: "TransType", render: row => row?.invoice_data[0]?.TransType },
                                            { title: "DueDate", field: "DueDate", render: row => moment(row?.invoice_data[0]?.DueDate, 'YYYYMMDDHHmmss').format("DD/MM/YYYY") },
                                            { title: "BillCycleBeginTime", field: "BillCycleBeginTime", render: row => moment(row?.invoice_data[0]?.BillCycleBeginTime, 'YYYYMMDDHHmmss').format("DD/MM/YYYY") },
                                            { title: "BillCycleEndTime", field: "BillCycleEndTime", render: row => moment(row?.invoice_data[0]?.BillCycleEndTime, 'YYYYMMDDHHmmss').format("DD/MM/YYYY") },
                                            { title: "Invoice_Amount", field: "InvoiceAmount", render: row => parseInt(row?.invoice_data[0]?.InvoiceAmount).toLocaleString() },
