...
function DeductNew() {
    ...
    const columns = [
        ...
        { title: 'TransactionID', field: 'transactionId', minWidth: 180 },
        ...
        { title: 'ລາຍລະອຽດ', field: 'resultDesc', minWidth: 400 },
        {
            title: 'ສະຖານະ', field: 'resultCode', render: row => (Number(row.resultCode) === 200 || Number(row.resultCode) === 0) ?
        ...
        <MaterialTable
            ...
            data={query =>
                new Promise((resolve, reject) => {
                    ...
                    AxiosElastic.post("repayment-log*/_search", sendData).then(res => {
                        if (res.status === 200) {
                            ...
                            var update = res.data.hits.hits.map(row => {
                                ...
                                return {
                                    ...
                                    date: moment(source.CreateAt).format("DD-MM-YYYY HH:mm:ss"),
                                    userId: source.Create_By,
                                    amount: source.Total_Debt,
