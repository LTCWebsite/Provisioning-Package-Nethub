...
function TableMservice({ url: URL, sl: SL, title, columns }) {
        ...
        <>
            <MaterialTable
                ...
                options={{
                    ...
                    rowStyle: (rows) => {
                        return {
                            backgroundColor: rows?.resultCode === "200" || rows?.transactionName === "200 : Operation successed." || rows?.transactionName === "1000 : Operation successed." ? null : '#ffddd2'
                        }
                    }
                }}
            />
